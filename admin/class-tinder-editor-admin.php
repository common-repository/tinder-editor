...
class Tinder_Editor_Admin {
	...
	public function tinder_ajax_handler() {

		if ( is_user_logged_in() && current_user_can('edit_posts') ) {

			check_ajax_referer( 'tinder_editor', '_ajax_nonce', true );
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/tinder-editor-admin.css', array(), $this->version, 'all' );

	}

	public function enqueue_scripts() {

		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/tinder-editor-admin.js', array( 'jquery' ), $this->version, false );
